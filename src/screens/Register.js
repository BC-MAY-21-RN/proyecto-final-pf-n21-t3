...
import { setEmail, setName } from '../redux/Actions.js';
...
export const Register = () => {
  ...
  return (
    <Container>
      ...
      <InputLog placeholderAdj={'Nombre'} name={'user-alt'} value={setNombre}  onChangeText={(valor)=> Store.dispatch(setName(valor)) }/>
